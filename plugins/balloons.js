...
var c = document.getElementById("balloons");
...
var colorCodes = [10, 100, 220]

function Balloon() {
  this.r = randomIntFromInterval(60, 100);
  this.R = 1.4 * this.r;
  ...
  this.k = this.speed / 5;
  this.hue = colorCodes[Math.floor(Math.random() * colorCodes.length)];
}
